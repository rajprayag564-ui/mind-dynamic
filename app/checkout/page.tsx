  ...
  return (
    <div className="min-h-screen bg-[color:var(--color-bg)] text-[color:var(--color-text)]">
      ...
      <main className="mx-auto w-full max-w-6xl px-4 py-12">
        ...
        <p className="mt-2 text-sm text-blue-100">Pay via UPI. Your payment will be verified by our admin and activated shortly.</p>

        <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
          <CheckoutForm title={product!.title} amount={product!.priceInr} />
        </div>
      </main>
      <SiteFooter />
    </div>
