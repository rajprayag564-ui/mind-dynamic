    ...
    <section className="relative overflow-hidden border-b border-white/10">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl gap-12 px-4 py-14 sm:px-6 md:grid-cols-2 md:items-center md:py-20 lg:gap-16">
        ...
        <div className="relative animate-float">
          <div className="mx-auto w-full max-w-[620px] rounded-[2rem] border border-white/10 bg-white/5 p-3 shadow-2xl shadow-blue-500/20 backdrop-blur-sm sm:p-4">
            <div className="overflow-hidden rounded-[1.6rem] border border-white/10 bg-[#050816] shadow-2xl shadow-black/40">
              ...
              <div className="grid gap-0 md:grid-cols-[1.45fr_0.85fr]">
                <div className="relative min-h-[280px] sm:min-h-[340px]">
                  ...
                  <div className="absolute inset-x-4 bottom-4 rounded-2xl border border-white/10 bg-[#0A0F2C]/85 p-4 backdrop-blur-md">
                ...
                <div className="border-t border-white/10 bg-[#0B1438] p-5 md:border-l md:border-t-0">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-[0.24em] text-blue-200/70">
                      Inside the Program
                    </p>
                    <div className="mt-4 space-y-3">
                      <div className="rounded-xl bg-[#0A0F2C] px-4 py-3">
